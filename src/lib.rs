...
#[derive(Debug)]
pub struct ReactFlowProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ReactFlowProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ReactFlow processing");
    
    let mut processor = ReactFlowProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ReactFlowProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ReactFlowProcessor::new(false);
